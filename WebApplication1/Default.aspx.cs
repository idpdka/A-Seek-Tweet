        ...
        
    {
        ...
        public void seekTwit(object sender, EventArgs e)
        {
            ...
            foreach (var tweet in results)
            {
                ...
                nama[i] = tweet.User.Name.ToString();
                i++;
            }
                ...
                for (i=0;i<200;i++)
                {
                    if (arraytweet[i] != null)
                    {
                        ...
                        if (found != false) //ada selain -1
                        {
                            ...
                            if (jmin == 0)
                            {
                                dinasKebersihan.Text += "<p>" + nama[i] + " : " + TwitterExtensions.TextAsHtml(arraytweet[i]) + "<br>" ;
                                countKebersihan++;
                            }
                            else if (jmin == 1)
                            {
                                dinasPertamanan.Text += "<p>" + nama[i] + " : " + TwitterExtensions.TextAsHtml(arraytweet[i]) + "<br>";
                                countTaman++;
                            }
                            else if (jmin == 2)
                            {
                                dinasPendidikan.Text += "<p>" + nama[i] + " : " + TwitterExtensions.TextAsHtml(arraytweet[i]) + "<br>";
                                countPendidikan++;
                            }
                            else if (jmin == 3)
                            {
                                dinasPerhubungan.Text += "<p>" + nama[i] + " : " + TwitterExtensions.TextAsHtml(arraytweet[i]) + "<br>";
                                countPerhubungan++;
                            }
                            else if (jmin == 4)
                            {
                                dinasSosial.Text += "<p>" + nama[i] + " : " + TwitterExtensions.TextAsHtml(arraytweet[i]) + "<br>";
                                countSosial++;
                            }
                        } else
                        {
                            dinasUnknown.Text += "<p>" + nama[i] + " : " + TwitterExtensions.TextAsHtml(arraytweet[i]) + "<br>";
                            countUnknown++;
                        }
